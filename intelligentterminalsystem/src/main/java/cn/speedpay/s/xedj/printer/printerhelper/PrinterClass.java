...
public interface PrinterClass {
	 ...
	 * 水平制表值
	 */
	public static final byte[] CMD_HORIZONTAL_TAB_VALUE=new byte[]{0x1B,0x44,0x8,0x0};
	 ...
	 * 走底几行  6
	 */
	public static final byte[] CMD_PRINT_LOCATION=new byte[]{0x1B,0x4A,0x6};
	public static final byte[] CMD_PRINT_MORELOCATION=new byte[]{0x1B,0x4A,0x30};
	/**
	 * 左限
	 */
	public static final byte[] CMD_LEFT_LOCATION=new byte[]{0x1B,0x6C,0x0};
	/**
	 * 进字符
	 */
	public static final byte[] CMD_N_ZHIFU=new byte[]{0x1B,0x64,0x3};

	/**
	 * 获取打印机状态
	 */
	public static final byte[] CMD_POST_STATE=new byte[]{0x1b,0x76};
}
