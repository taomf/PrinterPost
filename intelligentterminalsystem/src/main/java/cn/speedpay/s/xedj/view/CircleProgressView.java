...
public class CircleProgressView extends View{
    ...
    public CircleProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = array.getDimension(R.styleable.CircleProgressBar_border, 4.0f);
        angleAnimatorDuration = array.getInt(R.styleable.CircleProgressBar_angleAnimationDurationMillis, 2000);
        sweepAnimatorDuration = array.getInt(R.styleable.CircleProgressBar_sweepAnimationDurationMillis, 900);
        minSweepAngle = array.getInt(R.styleable.CircleProgressBar_minSweepAngle,30);
        int colorArrayId = array.getResourceId(R.styleable.CircleProgressBar_colorSequence, R.array.circle_default_color_sequence);
        if (isInEditMode()){
            mColors = new int[4];
            mColors[0] = getResources().getColor(R.color.circular_blue,null);
            mColors[1] = getResources().getColor(R.color.circular_green,null);
            mColors[2] = getResources().getColor(R.color.circular_red,null);
            mColors[3] = getResources().getColor(R.color.circular_yellow,null);
        }else {
